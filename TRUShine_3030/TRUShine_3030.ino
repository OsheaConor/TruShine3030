...
static float CHAR_MAP[COORD_AMOUNT][2] = {
  ...
  { 1.0, 0.5 },
  { 0.0, 0.5 },
  { 1.0, 0.125 },  //R[6] (95-100)
  { 0.0, 0.125 },
  { 1.0, 0.125 },
  { 1.0, 0.5 },
  { 0.0, 0.5 },
  { 0.0, 0.875 },
  { 1.0, 0.875 },  //S[6] (101-106)
  { 0.5, 0.125 },
  { 0.5, 0.875 },
  { 0.0, 0.875 },
  { 1.0, 0.875 },  //T[4] (107-110)
  { 0.0, 0.875 },
  { 0.0, 0.125 },
  { 1.0, 0.125 },
  { 1.0, 0.875 },  //U[4] (111-114)
  { 0.0, 0.875 },
  { 0.5, 0.125 },
  { 1.0, 0.875 },  //V[3] (115-117)
  { 0.0, 0.875 },
  { 0.25, 0.125 },
  { 0.5, 0.5 },
  { 0.75, 0.125 },
  { 1.0, 0.875 },  //W[5] (118-122)
  { 0.0, 0.875 },
  { 1.0, 0.125 },
  { 0.5, 0.5 },
  { 0.0, 0.125 },
  { 1.0, 0.875 },  //X[5] (123-127)
  { 0.0, 0.875 },
  { 0.5, 0.5 },
  { 1.0, 0.875 },
  { 0.5, 0.5 },
  { 0.5, 0.125 },  //Y[5] (128-132)
  { 1.0, 0.125 },
  { 0.0, 0.125 },
  { 1.0, 0.875 },
  { 0.0, 0.875 }  //Z[4] (133-136)
};
