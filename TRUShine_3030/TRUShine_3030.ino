...
static uint CHAR_INDEXES[CHAR_AMOUNT] = {0, 5, 15, 19, 26, 33, 39, 45, 51, 53, 58, 64, 67, 72, 76, 81, 86, 95, 101, 107, 111, 115, 119, 124, 129, 134};
...
static float CHAR_MAP[COORD_AMOUNT][2] = {
  ...
  {0.0, 0.875}, {0.5, 0.125}, {1.0, 0.875},                                                                                                                       //V[3] (115-118)
  {0.0, 0.875}, {0.25, 0.125},{0.5, 0.5},    {0.75, 0.125}, {1.0, 0.875},                                                                                         //W[5] (119-123)
  {0.0, 0.875}, {1.0, 0.125}, {0.5, 0.5},    {0.0, 0.125},  {1.0, 0.875},                                                                                         //X[5] (124-128)
  {0.0, 0.875}, {0.5, 0.5},   {1.0, 0.875},  {0.5, 0.5},    {0.5, 0.125},                                                                                         //Y[5] (129-133)
  {1.0, 0.125}, {0.0, 0.125}, {1.0, 0.875},  {0.0, 0.875}                                                                                                         //Z[4] (134-137)
};
